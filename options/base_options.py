...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--root', type=str, default='/datasets', help='path to target dataset')
        parser.add_argument('--dataset', type=str, default='kitti', help='img dataset')
        parser.add_argument('--batchSize', type=int, default=2, help='input batch size')
        parser.add_argument('--loadSize', nargs='+', type=int, default=(192, 640), help='scale images to this size')
        parser.add_argument('--n_layers_D', type=int, default=3, help='only used if which_model_netD==n_layers')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--model', type=str, default='mix', help='chooses which model to use')
